...
const newUpdateAvailableTooltip = () => {
  return (
    <Tooltip id="navbarBrandTooltip" style={{color: '#fff'}}>
        ...
        <Navbar.Collapse>
          <Nav pullRight>
            ...
            >
              ...
              <MenuItem href="https://github.com/cncjs/cncjs/wiki" target="_blank">
                {i18n._('Help')}
              </MenuItem>
              <MenuItem href="https://github.com/cncjs/cncjs/issues" target="_blank">
                {i18n._('Report an issue')}
              </MenuItem>
            </NavDropdown>
          </Nav>
          {location.pathname === '/workspace' && <QuickAccessToolbar state={this.state} actions={this.actions} />}
        </Navbar.Collapse>
      </Navbar>
    );
  }

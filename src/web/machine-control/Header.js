...
class Header extends PureComponent {
  ...
  get machineConnect() {
    ...
    return (
      <Fragment>
        <Button text={i18n._('Connect Machine')} isDisabled={isDisabled} onClick={connectMachine} />
        <Button text={i18n._('Home Machine')} icon="homing" isDisabled={isDisabled} onClick={homeMachine} />
      </Fragment>
    );
  }
